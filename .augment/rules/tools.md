...
description: "This document provides an overview of the tools available within the `src/mastra/tools/` directory. These tools are designed to extend the capabilities of Mastra agents, allowing them to interact with external services, manage data, and perform specialized operations."
---
