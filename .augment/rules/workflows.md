...
description: "This document provides an overview of the workflows available within the `src/mastra/workflows/` directory. These workflows define multi-step processes that orchestrate various agents and tools to achieve complex goals."
---
